...
[![GoDoc](https://godoc.org/github.com/hpe-hcss/go-git/v5?status.svg)](https://pkg.go.dev/github.com/hpe-hcss/go-git/v5) [![Build Status](https://github.com/hpe-hcss/go-git/workflows/Test/badge.svg)](https://github.com/hpe-hcss/go-git/actions) [![Go Report Card](https://goreportcard.com/badge/github.com/go-git/go-git)](https://goreportcard.com/report/github.com/go-git/go-git)

*go-git* is a highly extensible git implementation library written in **pure Go**.

It can be used to manipulate git repositories at low level *(plumbing)* or high level *(porcelain)*, through an idiomatic Go API. It also supports several types of storage, such as in-memory filesystems, or custom implementations, thanks to the [`Storer`](https://pkg.go.dev/github.com/hpe-hcss/go-git/v5/plumbing/storer) interface.
...
```go
import "github.com/hpe-hcss/go-git/v5" // with go modules enabled (GO111MODULE=on or outside GOPATH)
...
> Please note that the `CheckIfError` and `Info` functions  used in the examples are from the [examples package](https://github.com/hpe-hcss/go-git/blob/master/_examples/common.go#L19) just to be used in the examples.
...
[Contributions](https://github.com/hpe-hcss/go-git/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) are more than welcome, if you are interested please take a look to
